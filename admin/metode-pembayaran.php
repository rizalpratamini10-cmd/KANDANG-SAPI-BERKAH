...
$query = "SELECT * FROM metode_pembayaran ORDER BY is_active DESC, created_at DESC";
$result = mysqli_query($conn, $query);

$total_bank = mysqli_num_rows($result);
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="admin-wrapper">
    ...
    <div class="admin-main">
        ...
        <div class="mobile-nav">
            ...
            <div class="nav-right">
                <a href="metode-pembayaran-tambah.php" class="btn-add-mobile">
        ...
        <div class="admin-header">
            ...
            <div class="header-right">
                <a href="metode-pembayaran-tambah.php" class="btn-add">
        ...
        <div class="stats-grid">
            <div class="stat-box">
                <div class="stat-number"><?php echo $total_bank; ?></div>
                <div class="stat-label">🏦 Total Rekening</div>
            </div>
            <?php
            $active = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as total FROM metode_pembayaran WHERE is_active = 1"))['total'];
            $inactive = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as total FROM metode_pembayaran WHERE is_active = 0"))['total'];
            ?>
            <div class="stat-box">
                <div class="stat-number active"><?php echo $active; ?></div>
                <div class="stat-label">✅ Aktif</div>
            </div>
            <div class="stat-box">
                <div class="stat-number inactive"><?php echo $inactive; ?></div>
                    ...
                    <?php if(mysqli_num_rows($result) > 0): ?>
                        <?php while($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="metode-pembayaran-edit.php?id=<?php echo $row['id']; ?>" class="btn-icon btn-edit">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="metode-pembayaran-hapus.php?id=<?php echo $row['id']; ?>" class="btn-icon btn-delete" onclick="return confirm('Yakin hapus rekening ini?')">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" style="text-align: center; padding: 40px; color: #999;">
                                ...
                                <br><br>
                                <a href="metode-pembayaran-tambah.php" style="color: #2c5f2d; text-decoration: none; font-weight: 600;">+ Tambah rekening pertama</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
