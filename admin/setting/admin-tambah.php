...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(strlen($password) < 6) {
        ...
        $cek = "SELECT id FROM admin WHERE username = '$username'";
        $cek_result = mysqli_query($conn, $cek);
        if(mysqli_num_rows($cek_result) > 0) {
            $error = "Username sudah digunakan!";
        } else {
            $hashed = hashPassword($password);
            $query = "INSERT INTO admin (username, password, nama_lengkap, email, level) VALUES ('$username', '$hashed', '$nama_lengkap', '$email', '$level')";
...
<div class="admin-wrapper">
    ...
    <div class="admin-main">
        ...
        <div class="mobile-nav">
            ...
            <div class="page-title-mobile">➕ Tambah Admin</div>
        </div>
        ...
        <div class="form-card">
            ...
            <?php endif; ?>
            <?php if($success): ?>
                <div class="alert-success">✅ <?php echo $success; ?> <a href="admin.php" style="color: #27ae60; font-weight: 600;">Lihat daftar admin</a></div>
            <?php endif; ?>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <select name="level" required>
                        <option value="admin">🛡️ Admin Biasa</option>
                        <option value="super_admin">👑 Super Admin</option>
                    </select>
                </div>
                <button type="submit" class="btn-save"><i class="fas fa-user-plus"></i> Tambah Admin</button>
