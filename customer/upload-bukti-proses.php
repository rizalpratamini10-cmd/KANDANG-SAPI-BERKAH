    ...
    <div class="alamat-section">
        ...
        <div class="alamat-grid">
            <div class="item">
                ...
                <span class="value"><?php echo htmlspecialchars($nama_penerima ?: '-'); ?></span>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <span class="value"><?php echo htmlspecialchars($no_hp ?: '-'); ?></span>
            </div>
            <div class="item">
                <span class="label">Alamat Lengkap</span>
                <span class="value"><?php echo htmlspecialchars($alamat ?: '-'); ?></span>
            </div>
            <?php if($catatan): ?>
            <div class="item full-width">
                <span class="label">Catatan</span>
                <span class="value"><?php echo htmlspecialchars($catatan); ?></span>
            </div>
            <?php endif; ?>
        </div>
    </div>
